...
variable "subnet_names-vnet-hub" {
  ...
  default     = ["GatewaySubnet","AzureFirewallSubnet","snet-eus-prd-hub-identity-01", "snet-eus-prd-hub-mgmt-01", "snet-eus-prd-hub-connectivity-01"]
}
...
variable "subnet_names-vnet-spoke1" {
  ...
  default     = ["snet-eus-prd-spoke1-web-01", "snet-eus-prd-spoke1-app-01", "snet-eus-prd-spoke1-db-01"]
}
...
variable "subnet_names-vnet-spoke2" {
  ...
  default     = ["snet-eus-prd-spoke2-web-01", "snet-eus-prd-spoke2-app-01", "snet-eus-prd-spoke2-db-01"]
}
