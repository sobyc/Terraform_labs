...
data "azurerm_subnet" "hub-identity" {
  name                 = "snet-wi-prd-hub-identity-01"
  virtual_network_name = "vnet-wi-prd-hub-01"
  resource_group_name  = "rg-wi-prd-hub-01"
}
...
data "azurerm_subnet" "hub-connectivity" {
  name                 = "snet-wi-prd-hub-connectivity-01"
  virtual_network_name = "vnet-wi-prd-hub-01"
  resource_group_name  = "rg-wi-prd-hub-01"
}
...
data "azurerm_subnet" "spoke1-web" {
  name                 = "snet-wi-prd-spoke1-web-01"
  virtual_network_name = "vnet-wi-prd-spoke-01"
  resource_group_name  = "rg-wi-prd-spoke-01"
}
...
data "azurerm_subnet" "spoke1-app" {
  name                 = "snet-wi-prd-spoke1-app-01"
  virtual_network_name = "vnet-wi-prd-spoke-01"
  resource_group_name  = "rg-wi-prd-spoke-01"
}
...
data "azurerm_subnet" "spoke2-web" {
  name                 = "snet-wi-prd-spoke2-web-01"
  virtual_network_name = "vnet-wi-prd-spoke-02"
  resource_group_name  = "rg-wi-prd-spoke-02"
}
...
data "azurerm_subnet" "spoke2-app" {
  name                 = "snet-wi-prd-spoke2-app-01"
  virtual_network_name = "vnet-wi-prd-spoke-02"
  resource_group_name  = "rg-wi-prd-spoke-02"
}
